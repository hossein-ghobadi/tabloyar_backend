...
//{
//    public class SwediMaxMapper
//    {
//        public RequestSwediMaxPriceDto Mapper(ChannelliumViewModel model)
//        {
//            try
//            {
...
//            data.secondEdgeColor != null && !string.IsNullOrEmpty(data.secondEdgeColor.label);

//        private bool IsValidModelLayerLetters(modelLayerLetters letters) =>
//            letters?.one?.colorPelekcy != null &&
//            !string.IsNullOrEmpty(letters.one.colorPelekcy.label) &&
