...
{
    public class SwediMappingDto
    {

        public  SwediRequest MapJsonToRequestChallCostDto(JObject jsonData, JObject data)
        {
            int Checkpoint = 1;
            ...
            try
            {
                ...
                var request1 = new RequestSwediPriceDto
                {
                ...
                var request2 = new RequestSwediNfpInfoDto
                {
                ...
                catch (Exception)
                {
                    ...
                    //return new SwediRequest
                    //{
                    //    Message = " خطا در دریافت درجه کیفی پاور",
                    //    Request1 = new RequestSwediPriceDto(),
                    //    Request2 = new RequestSwediNfpInfoDto(),
    ...
    public class SwediRequest
    {
        public string Message { get; set; }

        public RequestSwediPriceDto Request1 { get; set; }
        public RequestSwediNfpInfoDto Request2 { get; set; }
