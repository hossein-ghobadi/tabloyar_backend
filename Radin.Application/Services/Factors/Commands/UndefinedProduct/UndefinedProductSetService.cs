...
//{
//    public class UndefinedProductSetService: IUndefinedProductSetService
//    {

//        private readonly IDataBaseContext _context;
//        private readonly IUpdatePrice _updatePrice;

//        public UndefinedProductSetService(IDataBaseContext context, IUpdatePrice updatePrice)
//        {
//            _context = context;
...
//        public async Task<ResultDto<long>> UndefinedProductSet(UndefinedProductRequestDto request)
//        {
...
//                    var model =new DescriptionImage { Description=request.Description,Image= image, Id=request.Id};
...
//                            IsAccessory = false,
//                            IsUndefinedProduct = true,
//                            ProductDetails= ProductDetails,
//                            UndefinedProductCode = Convert.ToInt32(request.Id)
...
//                            existingProduct.IsUndefinedProduct = true;
//                            existingProduct.ProductDetails = ProductDetails;
//                            existingProduct.UndefinedProductCode = Convert.ToInt32(request.Id);
