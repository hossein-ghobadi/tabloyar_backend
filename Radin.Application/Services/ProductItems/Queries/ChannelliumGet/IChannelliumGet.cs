...
namespace Radin.Application.Services.ProductItems.Queries.ChannelliumGet
{
    public interface IChannelliumGet
    {

        ResultDto<ResultChannelliumGetDto> Execute(string request);

    }

    public class ChannelliumGet : IChannelliumGet
    {
        private readonly IPriceFeeDataBaseContext _context;
        public ChannelliumGet(IPriceFeeDataBaseContext Context)
        {
            _context = Context;

        }
        public ResultDto<ResultChannelliumGetDto> Execute(string request)
        {
            ...
            var secondColor = smds.Where(p => p.SmdTitle.Contains(request) && p.SmdModel==ConstantMaterialName.mixedColor)
            ...
            var resultData = new ResultChannelliumGetDto
            {
            ...
            return new ResultDto<ResultChannelliumGetDto>
            {
                Data = resultData,
                IsSuccess = true,
        ...
        public class ResultChannelliumGetDto
        {
